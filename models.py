...
class EmpresaAudit(Base):
    __tablename__ = "empresa_audit"
...
class EmpresaDeletion(Base):
    __tablename__ = "empresas_deletions"

    id = Column(Integer, primary_key=True)
    empresa_id = Column(Integer, index=True)   # ID original, no FK
...
class ResponsableDeletion(Base):
    ...
    id = Column(Integer, primary_key=True)
    responsable_id = Column(Integer, index=True)   # ID original, no FK
    id_responsable = Column(String(30))
